...
public class RoleService : IRoleService
{
    ...
    public async Task<bool> UpdateRoleAsync(UpdateRoleDto request, CancellationToken cancellationToken = default)
    {
    ...
    public async Task<bool> AssignPermissionsAsync(AssignPermissionsDto request, CancellationToken cancellationToken = default)
    {
